          ...
          <div ref={heroLeftRef} className="reveal-left">
            ...
            <div style={{
              ...
              <span style={{
                ...
                Extended Producer Responsibility — CPCB Certified Consultants
              </span>
            </div>
            ...
            <h1 style={{
              ...
              EPR Registration{" "}
              <span style={{ color: T.orange }}>under CPCB</span>{" "}
              Norms
            </h1>
          ...
          <div className="overview-grid">
            ...
            <div className="reveal-left" ref={overviewRef}>
              ...
              <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.01em", marginBottom: 16 }}>
                Complete EPR Compliance, Handled for You
              </h2>
              ...
              <p style={{ fontFamily: T.sans, fontSize: 15.5, color: T.para, lineHeight: 1.9, marginBottom: 32, textAlign: "justify" }}>
                Our EPR specialists prepare and file your CPCB registration, connect you with empanelled PROs for waste collection targets, and manage all annual return filings — so you stay compliant without the hassle.
              </p>
                ...
                <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", padding: "0 28px" }}>
                  <div>
                    <div style={{ fontFamily: T.serif, fontSize: "clamp(1rem,2vw,1.3rem)", color: "#fff", fontWeight: 700, marginBottom: 4 }}>
                      Avoid CPCB Penalties Up to ₹1L / Day
                    </div>
      ...
      <section className="sec" style={{ background: T.white }}>
        <div className="inner">
          <div style={{ textAlign: "center", marginBottom: 52 }} className="reveal" ref={typesTtlRef}>
            ...
            <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em", marginBottom: 14 }}>Which EPR Registration Do You Need?</h2>
      ...
      <section className="sec" style={{ background: T.cream }}>
        <div className="inner">
          <div style={{ textAlign: "center", marginBottom: 52 }} className="reveal" ref={procTtlRef}>
            ...
            <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em", marginBottom: 14 }}>EPR Registration Process</h2>
          </div>
          ...
          <div className="reveal-scale" ref={bannerRef} style={{ position: "relative", borderRadius: 10, overflow: "hidden", marginBottom: 36, height: 170 }}>
            ...
            <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", padding: "0 40px" }}>
              <div>
                <div style={{ fontFamily: T.serif, fontSize: "clamp(1.1rem,2vw,1.4rem)", color: "#fff", fontWeight: 700, marginBottom: 6 }}>End-to-End EPR Compliance</div>
                <p style={{ fontFamily: T.sans, color: "rgba(255,255,255,0.78)", fontSize: 13 }}>From eligibility check to annual returns — we manage every step.</p>
              </div>
            </div>
          </div>
            ...
            {steps.map((s, i) => (
              <div key={s.step} className={`reveal d${i % 6}`} style={{ background: T.white, borderRadius: 10, padding: 24, border: `1px solid ${T.border}`, display: "flex", gap: 16, alignItems: "flex-start", transition: "all 0.2s" }}
                ...
                <div>
                  ...
                  <p style={{ fontFamily: T.sans, fontSize: 15, color: T.para, lineHeight: 1.7, margin: 0 }}>{s.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="sec" style={{ background: T.cream }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }} className="reveal" ref={faqTtlRef}>
            ...
            <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em" }}>EPR Registration FAQs</h2>
          </div>
          <div ref={faqRef}>
            {faqs.map((faq, i) => (
          ...
          <div className="cta-split">
            <div>
              ...
              <h2 style={{ fontFamily: T.serif, fontSize: "clamp(1.9rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.01em", marginBottom: 14 }}>
                Stay Compliant<br />with EPR Norms
              </h2>
              <p style={{ fontFamily: T.sans, color: T.para, fontSize: 14.5, lineHeight: 1.8 }}>
                Get your EPR registration done before facing CPCB penalties. Talk to our experts for free.<br />Clear timeline. Transparent pricing.
              </p>
            </div>
