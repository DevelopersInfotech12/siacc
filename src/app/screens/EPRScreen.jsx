        ...
        <div className="inner">
          ...
          <div className="reveal-scale" ref={bannerRef} style={{ position: "relative", borderRadius: 10, overflow: "hidden", marginBottom: 36, height: 170 }}>
            ...
            <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", padding: "0 40px" }}>
              <div>
                <div style={{ fontFamily: T.poppins, fontSize: "clamp(1.1rem,2vw,1.4rem)", color: "#fff", fontWeight: 700, marginBottom: 6 }}>End-to-End EPR Compliance</div>
      ...
      <section style={{ position: "relative", overflow: "hidden" }} className="sec">
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ textAlign: "center", marginTop: 24, fontFamily: T.sans, fontSize: 13, color: "rgba(255,255,255,0.50)" }}>
            ...
            <button onClick={() => router.push("/contact")} style={{ color: T.teal, fontWeight: 600, background: "none", border: "none", cursor: "pointer", fontFamily: T.poppins, fontSize: 13 }}>
      ...
      <section className="sec" style={{ background: T.cream }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }} className="reveal" ref={faqTtlRef}>
            ...
            <h2 style={{ fontFamily: T.poppins, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em" }}>EPR Registration FAQs</h2>
          </div>
          <div ref={faqRef}>
            {faqs.map((faq, i) => (
