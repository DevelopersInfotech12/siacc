...
export default function EPRScreen() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: T.white, fontFamily: T.sans, color: T.body }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "clamp(56px,8vw,96px) clamp(16px,4vw,56px)" }}>
          <div className="hero-grid">
            ...
            <div>
              ...
              <p style={{ fontFamily: T.sans, fontSize: 16, color: T.muted, lineHeight: 1.9, marginBottom: 32, maxWidth: 480, textAlign: "justify" }}>
            ...
            {/* Right — light info card matching BISScreen */}
      ...
      <section className="sec" style={{ background: T.cream }}>
        <div className="inner">
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            <p style={{ fontFamily: T.sans, color: T.muted, maxWidth: 480, margin: "0 auto", lineHeight: 1.75, fontSize: 16 }}>Different waste categories require different EPR registrations. Here's what applies to your product.</p>
          </div>
      ...
      {/* ── DOCUMENTS — dark image + teal overlay ── */}
      ...
      {/* ── CTA BAND — exact BISScreen pattern ── */}
