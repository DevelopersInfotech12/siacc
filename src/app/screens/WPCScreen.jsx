...
export default function WPCScreen() {
  ...
  return (
    <div style={{minHeight:"100vh",backgroundColor:T.white,fontFamily:T.sans,color:T.body}}>
      ...
      {/* ══════════════════════════════════════
          OVERVIEW — description + CTA left | info card right
      ══════════════════════════════════════ */}
          ...
          <div className="overview-grid">
            ...
            <div className="reveal-left" ref={overviewRef}>
              ...
              <h2 style={{fontFamily:T.serif,fontSize:"clamp(2rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,lineHeight:1.1,letterSpacing:"-0.01em",marginBottom:16}}>
                End-to-End WPC Compliance, Handled for You
              </h2>
              ...
              <p style={{fontFamily:T.sans,fontSize:15.5,color:T.para,lineHeight:1.9,marginBottom:32,textAlign:"justify"}}>
                Our WPC specialists coordinate with recognized labs, prepare your complete application on the Saralsanchar portal, and follow up until your approval certificate is issued.
              </p>
                ...
                <div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",padding:"0 28px"}}>
                  <div>
                    <div style={{fontFamily:T.serif,fontSize:"clamp(1rem,2vw,1.3rem)",color:"#fff",fontWeight:700,marginBottom:4}}>
                      Trusted by 1,000+ Importers
                    </div>
                    <p style={{fontFamily:T.sans,color:"rgba(255,255,255,0.80)",fontSize:12.5}}>
                      WPC-ETA · Import License · DPL/NDPL · Equipment Type Approval
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div style={{maxWidth:1100,margin:"0 auto"}}>
          <div className="cta-split">
            <div>
              ...
              <h2 style={{fontFamily:T.serif,fontSize:"clamp(1.9rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,lineHeight:1.1,letterSpacing:"-0.01em",marginBottom:14}}>Import Your Wireless Device Legally</h2>
              <p style={{fontFamily:T.sans,color:T.para,fontSize:14.5,lineHeight:1.8}}>Don't risk customs detention. Get your WPC-ETA approval handled by experts.<br/>Free consultation. Clear timeline. Transparent pricing.</p>
            </div>
