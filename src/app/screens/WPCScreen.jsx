...
const steps=[
  ...
  {step:"06",title:"Post-Approval Support",desc:"We assist with renewal, compliance queries, and any follow-up requirements after approval.",icon:"🛡️"}
];
...
const trustBadges=["✓ Free Consultation","✓ 4–8 Wk Turnaround","✓ 98% Success Rate","✓ Pan-India"];
          ...
          <div className="hero-grid">
            <div className="reveal-left" ref={heroLeftRef}>
              ...
              <h1 style={{fontFamily:T.serif,fontSize:"clamp(2rem,3.8vw,3.4rem)",color:T.titleblue,fontWeight:700,lineHeight:1.08,marginBottom:10,letterSpacing:"-0.01em"}}
                dangerouslySetInnerHTML={{__html:"WPC-ETA Approval<br/>for Wireless Devices"}} />
              <p style={{fontFamily:T.sans,fontSize:12,fontWeight:600,color:T.tealMid,marginBottom:20,letterSpacing:"0.05em",textTransform:"uppercase"}}>Wi-Fi · Bluetooth · Zigbee · RF · IoT Devices</p>
              <p style={{fontFamily:T.sans,fontSize:16,color:T.muted,lineHeight:1.9,marginBottom:32,maxWidth:480,textAlign:"justify"}}>Mandatory Equipment Type Approval for all wireless, Bluetooth, Wi-Fi and RF devices imported into India. We handle the entire process — testing, filing and approval tracking.</p>
              <div style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:28}}>
                ...
                <button onClick={()=>router.push("/contact")}
                  ...
                  onMouseLeave={e=>{e.currentTarget.style.borderColor=T.border;e.currentTarget.style.color=T.white;e.currentTarget.style.background=T.orange;}}>Check Applicability →</button>
              </div>
      ...
      <section className="sec" style={{background:T.cream}}>
        <div className="inner">
          <div style={{textAlign:"center",marginBottom:52}} className="reveal" ref={typesTtlRef}>
            <div style={{display:"flex",justifyContent:"center"}}><div className="sl-row"><div className="sl-line sl-line-anim"/><span className="sl-text">Types of WPC Approval</span></div></div>
            <h2 style={{fontFamily:T.serif,fontSize:"clamp(2rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,letterSpacing:"-0.01em",marginBottom:14}}>Which WPC Approval Do You Need?</h2>
            <p style={{fontFamily:T.sans,color:T.muted,maxWidth:480,margin:"0 auto",lineHeight:1.75,fontSize:16}}>Different wireless devices require different WPC approvals. Here's a breakdown of what applies to your product.</p>
          </div>
      ...
      <section className="sec" style={{background:T.white}}>
        <div className="inner">
          <div style={{textAlign:"center",marginBottom:52}} className="reveal" ref={procTtlRef}>
            ...
            <h2 style={{fontFamily:T.serif,fontSize:"clamp(2rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,letterSpacing:"-0.01em",marginBottom:14}}>WPC Approval Process</h2>
          </div>
          <div className="reveal-scale" ref={bannerRef} style={{position:"relative",borderRadius:10,overflow:"hidden",marginBottom:36,height:170}}>
            <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=1400&q=80&fit=crop" alt="process" style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:"center 40%"}}/>
            ...
            <div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",padding:"0 40px"}}>
              <div>
                <div style={{fontFamily:T.serif,fontSize:"clamp(1.1rem,2vw,1.4rem)",color:"#fff",fontWeight:700,marginBottom:6}}>End-to-End WPC Compliance</div>
      ...
      <section className="sec" style={{background:T.cream}}>
        <div style={{maxWidth:800,margin:"0 auto"}}>
          <div style={{textAlign:"center",marginBottom:48}} className="reveal" ref={faqTtlRef}>
            ...
            <h2 style={{fontFamily:T.serif,fontSize:"clamp(2rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,letterSpacing:"-0.01em"}}>WPC Approval FAQs</h2>
          </div>
          <div ref={faqRef}>
            {faqs.map((faq,i)=>(
          ...
          <div className="cta-split">
            <div>
              ...
              <h2 style={{fontFamily:T.serif,fontSize:"clamp(1.9rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,lineHeight:1.1,letterSpacing:"-0.01em",marginBottom:14}}
                dangerouslySetInnerHTML={{__html:"Import Your Wireless<br/>Device Legally"}} />
              <p style={{fontFamily:T.sans,color:T.muted,fontSize:14.5,lineHeight:1.8}} dangerouslySetInnerHTML={{__html:"Don't risk customs detention. Get your WPC-ETA approval handled by experts.<br/>Free consultation. Clear timeline. Transparent pricing."}} />
            </div>
