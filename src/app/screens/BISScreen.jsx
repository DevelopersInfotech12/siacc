        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="cta-split">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, flexShrink: 0 }}>
              ...
              <a href="tel:+919540190334" style={{ padding: "13px 28px", border: `1.5px solid ${T.border}`, borderRadius: 6, fontFamily: T.poppins, fontSize: 14, fontWeight: 500, color: T.slate, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, whiteSpace: "nowrap", background: T.white, transition: "border-color 0.2s" }}
