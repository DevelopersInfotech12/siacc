...
const trustBadges=["✓ 50+ Lab Partners","✓ 1–12 Wk Turnaround","✓ 98% Success Rate","✓ Pan-India"];
          ...
          <div className="hero-grid">
            <div className="reveal-left" ref={heroLeftRef}>
              ...
              <h1 style={{fontFamily:T.serif,fontSize:"clamp(2rem,3.8vw,3.4rem)",color:T.titleblue,fontWeight:700,lineHeight:1.08,marginBottom:10,letterSpacing:"-0.01em"}}
                dangerouslySetInnerHTML={{__html:"Product Testing &amp;<br/>Certification Support"}} />
              <p style={{fontFamily:T.sans,fontSize:12,fontWeight:600,color:T.tealMid,marginBottom:20,letterSpacing:"0.05em",textTransform:"uppercase"}}>Lab Coordination · Report Review · Certification Filing</p>
              <p style={{fontFamily:T.sans,fontSize:16,color:T.muted,lineHeight:1.9,marginBottom:32,maxWidth:480,textAlign:"justify"}}>End-to-end lab testing coordination for all Indian regulatory certifications. We identify the right lab, manage sample submission, track progress, and review reports — so your certification isn't delayed by testing.</p>
              <div style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:28}}>
                ...
                <button onClick={()=>router.push("/contact")}
                  ...
                  onMouseLeave={e=>{e.currentTarget.style.borderColor=T.border;e.currentTarget.style.color=T.white;e.currentTarget.style.background=T.orange;}}>Check Testing Requirements →</button>
              </div>
      ...
      <section className="sec" style={{background:T.cream}}>
        <div className="inner">
          <div style={{textAlign:"center",marginBottom:52}} className="reveal" ref={typesTtlRef}>
            <div style={{display:"flex",justifyContent:"center"}}><div className="sl-row"><div className="sl-line sl-line-anim"/><span className="sl-text">Testing Categories</span></div></div>
            ...
            <p style={{fontFamily:T.sans,color:T.muted,maxWidth:480,margin:"0 auto",lineHeight:1.75,fontSize:16}}>We coordinate with accredited labs across India for all product categories and regulatory frameworks.</p>
          </div>
          ...
          <div className="cta-split">
            <div>
              ...
              <h2 style={{fontFamily:T.serif,fontSize:"clamp(1.9rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,lineHeight:1.1,letterSpacing:"-0.01em",marginBottom:14}}
                dangerouslySetInnerHTML={{__html:"Start Your Product<br/>Testing Today"}} />
              <p style={{fontFamily:T.sans,color:T.muted,fontSize:14.5,lineHeight:1.8}} dangerouslySetInnerHTML={{__html:"Don't let lab delays slow down your certification. Let our experts coordinate the entire testing process.<br/>Free consultation. Clear timeline. Transparent pricing."}} />
            </div>
