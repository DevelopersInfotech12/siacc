...
const documents = [
  "Factory premises proof and layout plan",
  "Company registration / incorporation certificate",
  "Quality Manual as per relevant IS standard",
  "Product test report from BIS-recognized lab",
  "Manufacturing process flowchart",
  "Authorized signatory KYC documents",
  "List of raw material suppliers",
  "Factory inspection preparation checklist",
];

const steps = [
  { step: "01", title: "IS Standard Identification", desc: "We identify the exact Indian Standard (IS) applicable to your product and the scheme requirements.", icon: "🔍" },
  { step: "02", title: "Lab Testing", desc: "Product samples are tested at a BIS-recognized lab against the relevant IS standard.", icon: "🧪" },
  { step: "03", title: "Application Filing", desc: "We prepare and file your complete ISI Mark application with BIS, including all required documents.", icon: "📤" },
  { step: "04", title: "Factory Inspection", desc: "BIS auditors inspect your manufacturing unit to verify quality systems and production processes.", icon: "🔎" },
  { step: "05", title: "License Grant", desc: "BIS issues the ISI Mark license. The IS number and CM/L number can be stamped on products.", icon: "🎓" },
  { step: "06", title: "Surveillance & Renewal", desc: "We assist with annual surveillance audits and license renewals to keep your ISI Mark valid.", icon: "🛡️" },
];
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: T.white, fontFamily: T.sans, color: T.body }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", borderBottom: `1px solid ${T.border}`, minHeight: 420, display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <img src="/finalimages/siaccbis.png" alt="BIS ISI Mark" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 40%", zIndex: 0 }} />
          ...
          <div className="overview-grid">
            <div className="reveal-left" ref={overviewRef}>
              ...
              <div style={{ position: "relative", borderRadius: 10, overflow: "hidden", marginBottom: 32, height: 220 }}>
                <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=900&q=80&fit=crop" alt="Manufacturing quality" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 40%" }} />
      ...
      <section className="sec" style={{ background: T.cream }}>
        <div className="inner">
          <div style={{ textAlign: "center", marginBottom: 52 }} className="reveal" ref={procTtlRef}>
            ...
            <h2 style={{ fontFamily: T.poppins, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em", marginBottom: 14 }}>ISI Mark Certification Process</h2>
          </div>
          <div className="reveal-scale" ref={bannerRef} style={{ position: "relative", borderRadius: 10, overflow: "hidden", marginBottom: 36, height: 170 }}>
            ...
            <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", padding: "0 40px" }}>
              <div>
                <div style={{ fontFamily: T.poppins, fontSize: "clamp(1.1rem,2vw,1.4rem)", color: "#fff", fontWeight: 700, marginBottom: 6 }}>End-to-End ISI Mark Support</div>
                <p style={{ fontFamily: T.sans, color: "rgba(255,255,255,0.78)", fontSize: 13 }}>Lab coordination, factory inspection prep, and BIS follow-up — managed by our experts.</p>
              </div>
            </div>
          </div>
      ...
      <section style={{ position: "relative", overflow: "hidden" }} className="sec">
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div style={{ textAlign: "center", marginBottom: 48 }} className="reveal" ref={docsTtlRef}>
            ...
            <h2 style={{ fontFamily: T.poppins, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: "#fff", fontWeight: 700, letterSpacing: "-0.01em" }}>Documents Required for ISI Mark</h2>
          </div>
          ...
          <p style={{ textAlign: "center", marginTop: 24, fontFamily: T.sans, fontSize: 13, color: "rgba(255,255,255,0.50)" }}>
            ...
            <button onClick={() => window.location.href = "/contact"} style={{ color: T.teal, fontWeight: 600, background: "none", border: "none", cursor: "pointer", fontFamily: T.poppins, fontSize: 13 }}>Contact us for a free document checklist →</button>
          </p>
        </div>
      </section>
        ...
        <div className="inner">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", borderRadius: 14, overflow: "hidden", border: `1px solid ${T.border}`, minHeight: 440 }} className="faq-grid">
            <div style={{ position: "relative", minHeight: 250, overflow: "hidden" }}>
              <img src="/finalimages/faq12.jpg" alt="BIS ISI FAQ" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 30%" }} />
            </div>
