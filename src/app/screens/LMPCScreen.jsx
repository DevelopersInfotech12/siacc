// ─────────────────────────────────────────────────────────────────────────────
// LMPCScreen.jsx  — with ISO-style hero + overview section
// ─────────────────────────────────────────────────────────────────────────────
...
export default function LMPCScreen() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: T.white, fontFamily: T.sans, color: T.body }}>
      ...
      {/* ══════════════════════════════════════
          HERO — full-bleed image (ISO style)
      ══════════════════════════════════════ */}
      <section style={{
      ...
      {/* ══════════════════════════════════════
          OVERVIEW — text left + sticky info card right
      ══════════════════════════════════════ */}
          ...
          <div className="overview-grid">
            ...
            <div className="reveal-left" ref={overviewRef}>
              ...
              <div style={{ position: "relative", borderRadius: 10, overflow: "hidden", marginBottom: 32, height: 220 }}>
                <img
                  src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=900&q=80&fit=crop"
                  alt="LMPC compliance team"
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {["✓ Free Consultation", "✓ 2–4 Week Timeline", "✓ 98% Success Rate", "✓ Pan-India"].map(b => (
        ...
        <div className="inner">
          <div style={{ textAlign: "center", marginBottom: 52 }} className="reveal" ref={typesTtlRef}>
            <div style={{ display: "flex", justifyContent: "center" }}>
              <div className="sl-row"><div className="sl-line" /><span className="sl-text">LMPC Registration Types</span></div>
            </div>
            <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em", marginBottom: 14 }}>Types of LMPC Registration</h2>
      ...
      <section className="sec" style={{ background: T.cream }}>
        <div className="inner">
          <div style={{ textAlign: "center", marginBottom: 52 }} className="reveal" ref={procTtlRef}>
            ...
            <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em" }}>LMPC Registration Process</h2>
          </div>
            ...
            {steps.map((s, i) => (
              <div key={s.step} className={`reveal d${i % 6}`} style={{ background: T.white, borderRadius: 10, padding: 24, border: `1px solid ${T.border}`, display: "flex", gap: 16, alignItems: "flex-start", transition: "all 0.2s" }}
                ...
                <div>
                  ...
                  <h3 style={{ fontFamily: T.serif, fontSize: 17, color: T.paradark, marginBottom: 6, fontWeight: 600 }}>{s.title}</h3>
      ...
      <section className="sec" style={{ background: T.white }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }} className="reveal" ref={faqTtlRef}>
            ...
            <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em" }}>LMPC Registration FAQs</h2>
          </div>
          <div ref={faqRef}>
            {faqs.map((faq, i) => (
