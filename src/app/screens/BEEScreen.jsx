                ...
                <div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",padding:"0 28px"}}>
                  <div>
                    <div style={{fontFamily:T.serif,fontSize:"clamp(1rem,2vw,1.3rem)",color:"#fff",fontWeight:700,marginBottom:4}}>
                      Trusted by 500+ Appliance Brands
                    </div>
                    <p style={{fontFamily:T.sans,color:"rgba(255,255,255,0.80)",fontSize:12.5}}>
                      Mandatory Star Rating · Voluntary · Annual Renewal · Label Design
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div style={{maxWidth:1100,margin:"0 auto"}}>
          <div className="cta-split">
            <div>
              ...
              <h2 style={{fontFamily:T.serif,fontSize:"clamp(1.9rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,lineHeight:1.1,letterSpacing:"-0.01em",marginBottom:14}}>Get BEE Star Rating for Your Product</h2>
              <p style={{fontFamily:T.sans,color:T.para,fontSize:14.5,lineHeight:1.8}}>Our energy compliance team will handle your BEE registration from start to finish.<br/>Free consultation. Clear timeline. Transparent pricing.</p>
            </div>
