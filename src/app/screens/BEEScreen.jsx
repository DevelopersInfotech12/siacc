...
const css=`
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .sl-text{font-family:'Outfit',sans-serif;font-size:11px;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;color:#1E88C8;}
  .hero-wrap{background:#FAF8F4;border-bottom:1px solid #E8E3DA;position:relative;overflow:hidden;}
  .hero-wrap::before{content:'';position:absolute;top:-100px;right:-140px;width:500px;height:500px;background:radial-gradient(circle,rgba(30,136,200,0.11) 0%,transparent 70%);border-radius:50%;pointer-events:none;animation:heroGlowPulse 6s ease-in-out infinite;}
...
const types=[
  ...
  {icon:"🏭",title:"BEE Act Compliance",tag:"Compliance",desc:"Complete BEE Act compliance for manufacturers including annual submissions and renewals."}
];
const steps=[
  ...
  {step:"06",title:"Annual Renewal Support",desc:"We assist with annual renewals, compliance submissions, and any label updates required by BEE.",icon:"🛡️"}
];
const docs=["Energy test report from BEE-accredited lab","Product technical specifications","Brand / Model details","Manufacturing unit details","KYC of company & signatory","Annual energy sales data","Label artwork proof","BIS certificate (if applicable)"];
const faqs=[
...
const trustBadges=["✓ Free Consultation","✓ 4–8 Wk Timeline","✓ Annual Renewal Support","✓ Pan-India"];
          ...
          <div className="hero-grid">
            <div className="reveal-left" ref={heroLeftRef}>
              ...
              <h1 style={{fontFamily:T.serif,fontSize:"clamp(2rem,3.8vw,3.4rem)",color:T.titleblue,fontWeight:700,lineHeight:1.08,marginBottom:10,letterSpacing:"-0.01em"}}
                dangerouslySetInnerHTML={{__html:"BEE Star Rating &amp;<br/>Energy Labelling"}} />
              <p style={{fontFamily:T.sans,fontSize:12,fontWeight:600,color:T.tealMid,marginBottom:20,letterSpacing:"0.05em",textTransform:"uppercase"}}>Mandatory &amp; Voluntary · Annual Renewal · Lab Coordination</p>
              <p style={{fontFamily:T.sans,fontSize:16,color:T.muted,lineHeight:1.9,marginBottom:32,maxWidth:480,textAlign:"justify"}}>Mandatory energy efficiency star labelling for appliances sold in India. We handle BEE registration, lab coordination, and annual compliance end-to-end.</p>
              <div style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:28}}>
                ...
                <button onClick={()=>router.push("/contact")}
                  ...
                  onMouseLeave={e=>{e.currentTarget.style.borderColor=T.border;e.currentTarget.style.color=T.white;e.currentTarget.style.background=T.orange;}}>Check If Mandatory →</button>
              </div>
              <div style={{display:"flex",flexWrap:"wrap",gap:8}}>
                {trustBadges.map(b=>(<span key={b} style={{padding:"6px 14px",border:`1px solid ${T.border}`,borderRadius:4,fontSize:12,color:T.muted,background:T.white,fontFamily:T.sans,fontWeight:500}}>{b}</span>))}
              </div>
            </div>
      ...
      <section className="sec" style={{background:T.cream}}>
        <div className="inner">
          <div style={{textAlign:"center",marginBottom:52}} className="reveal" ref={typesTtlRef}>
            <div style={{display:"flex",justifyContent:"center"}}><div className="sl-row"><div className="sl-line sl-line-anim"/><span className="sl-text">Registration Types</span></div></div>
            <h2 style={{fontFamily:T.serif,fontSize:"clamp(2rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,letterSpacing:"-0.01em",marginBottom:14}}>BEE Registration Types</h2>
            <p style={{fontFamily:T.sans,color:T.muted,maxWidth:480,margin:"0 auto",lineHeight:1.75,fontSize:16}}>Different appliances fall under different BEE schemes. Here's what applies to your product.</p>
          </div>
      ...
      <section className="sec" style={{background:T.white}}>
        <div className="inner">
          <div style={{textAlign:"center",marginBottom:52}} className="reveal" ref={procTtlRef}>
            ...
            <h2 style={{fontFamily:T.serif,fontSize:"clamp(2rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,letterSpacing:"-0.01em",marginBottom:14}}>BEE Registration Process</h2>
          </div>
      ...
      <section style={{position:"relative",overflow:"hidden"}} className="sec">
        ...
        <div style={{maxWidth:900,margin:"0 auto",position:"relative",zIndex:1}}>
          <div style={{textAlign:"center",marginBottom:48}} className="reveal" ref={docsTtlRef}>
            <div style={{display:"flex",justifyContent:"center"}}><div className="sl-row"><div className="sl-line" style={{background:"rgba(255,255,255,0.5)"}}/>
              <span className="sl-text" style={{color:"rgba(255,255,255,0.75)"}}>What You Need</span></div></div>
      ...
      <section className="sec" style={{background:T.cream}}>
        <div style={{maxWidth:800,margin:"0 auto"}}>
          <div style={{textAlign:"center",marginBottom:48}} className="reveal" ref={faqTtlRef}>
            ...
            <h2 style={{fontFamily:T.serif,fontSize:"clamp(2rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,letterSpacing:"-0.01em"}}>BEE Certification FAQs</h2>
          </div>
          <div ref={faqRef}>
            {faqs.map((faq,i)=>(
          ...
          <div className="cta-split">
            <div>
              ...
              <h2 style={{fontFamily:T.serif,fontSize:"clamp(1.9rem,3.2vw,2.9rem)",color:T.titleblue,fontWeight:700,lineHeight:1.1,letterSpacing:"-0.01em",marginBottom:14}}
                dangerouslySetInnerHTML={{__html:"Get BEE Star Rating<br/>for Your Product"}} />
              <p style={{fontFamily:T.sans,color:T.muted,fontSize:14.5,lineHeight:1.8}} dangerouslySetInnerHTML={{__html:"Our energy compliance team will handle your BEE registration from start to finish.<br/>Free consultation. Clear timeline. Transparent pricing."}} />
            </div>
