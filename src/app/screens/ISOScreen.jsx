      ...
      <section className="sec" style={{ background: T.cream }}>
        <div className="inner">
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            ...
            <p style={{ fontFamily: T.sans, color: T.muted, maxWidth: 480, margin: "0 auto", lineHeight: 1.75, fontSize: 16 }}>Choose the right ISO standard for your business goals and industry requirements.</p>
          </div>
