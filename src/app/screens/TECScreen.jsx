...
const T = {
  teal: "#1E88C8", tealDark: "#074D4D", tealMid: "#0E8080",para:"#080000b0", paradark:"#080000c4",
          ...
          <div ref={heroLeftRef} className="reveal-left">
            ...
            <div style={{
              ...
              <span style={{
                ...
                Telecom Engineering Centre — Certified Consultants
              </span>
            </div>
            ...
            <h1 style={{
              ...
              TEC / MTCTE Certification for{" "}
              <span style={{ color: T.orange }}>Telecom Products</span>
            </h1>
          ...
          <div className="overview-grid">
            ...
            <div className="reveal-left" ref={overviewRef}>
              ...
              <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.01em", marginBottom: 16 }}>
                Complete TEC / MTCTE Compliance, Handled for You
              </h2>
              ...
              <p style={{ fontFamily: T.sans, fontSize: 15.5, color: T.para, lineHeight: 1.9, marginBottom: 32, textAlign: "justify" }}>
                Our TEC specialists identify the applicable standards, coordinate with empanelled labs, prepare your complete MTCTE application, and follow up with TEC until your certificate is in hand.
              </p>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {["✓ Free Consultation", "✓ 6–12 Wk Timeline", "✓ 98% Success Rate", "✓ Pan-India"].map(b => (
        ...
        <div className="inner">
          <div style={{ textAlign: "center", marginBottom: 52 }} className="reveal" ref={typesTtlRef}>
            <div style={{ display: "flex", justifyContent: "center" }}>
              <div className="sl-row"><div className="sl-line" /><span className="sl-text">Certification Types</span></div>
            </div>
            <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em", marginBottom: 14 }}>TEC Certification Types</h2>
            <p style={{ fontFamily: T.sans, color: T.muted, maxWidth: 480, margin: "0 auto", lineHeight: 1.75, fontSize: 15 }}>Different telecom products require different TEC approvals. Here's what applies to your equipment.</p>
          </div>
          <div className="types-grid" ref={typesRef}>
            {types.map((t, i) => (
              <div key={t.title} className={`type-card reveal d${i % 4}`}>
                ...
                <p style={{ fontFamily: T.sans, fontSize: 15, color: T.para, lineHeight: 1.75, margin: 0, textAlign: "justify" }}>{t.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="sec" style={{ background: T.cream }}>
        <div className="inner">
          <div style={{ textAlign: "center", marginBottom: 52 }} className="reveal" ref={procTtlRef}>
            ...
            <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em", marginBottom: 14 }}>Certification Process</h2>
          </div>
          ...
          <div className="reveal-scale" ref={bannerRef} style={{ position: "relative", borderRadius: 10, overflow: "hidden", marginBottom: 36, height: 165 }}>
            ...
            <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", padding: "0 40px" }}>
              <div>
                <div style={{ fontFamily: T.serif, fontSize: "clamp(1.1rem,2vw,1.4rem)", color: "#fff", fontWeight: 700, marginBottom: 6 }}>End-to-End TEC / MTCTE Compliance</div>
          ...
          <div className="steps-grid" ref={stepsRef}>
            {steps.map((s, i) => (
              <div key={s.step} className={`reveal d${i % 5}`} style={{ background: T.white, borderRadius: 10, padding: 24, border: `1px solid ${T.border}`, display: "flex", gap: 16, alignItems: "flex-start", transition: "all 0.2s" }}
      ...
      <section style={{ position: "relative", overflow: "hidden" }} className="sec">
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ textAlign: "center", marginTop: 24, fontFamily: T.sans, fontSize: 13, color: "rgba(255,255,255,0.50)" }}>
            ...
            <button onClick={() => router.push("/contact")} style={{ color: T.teal, fontWeight: 600, background: "none", border: "none", cursor: "pointer", fontFamily: T.sans, fontSize: 13 }}>
      ...
      <section className="sec" style={{ background: T.cream }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }} className="reveal" ref={faqTtlRef}>
            ...
            <h2 style={{ fontFamily: T.serif, fontSize: "clamp(2rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, letterSpacing: "-0.01em" }}>Frequently Asked Questions</h2>
          </div>
          <div ref={faqRef}>
            {faqs.map((faq, i) => (
          ...
          <div className="cta-split">
            <div>
              ...
              <h2 style={{ fontFamily: T.serif, fontSize: "clamp(1.9rem,3.2vw,2.9rem)", color: T.titleblue, fontWeight: 700, lineHeight: 1.1, letterSpacing: "-0.01em", marginBottom: 14 }}>
                Get Your Telecom<br />Product Certified
              </h2>
              <p style={{ fontFamily: T.sans, color: T.para, fontSize: 14.5, lineHeight: 1.8 }}>
                Our TEC experts will guide you through the entire MTCTE process quickly and accurately.<br />Free consultation. Clear timeline.
              </p>
            </div>
