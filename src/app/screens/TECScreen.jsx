          ...
          <div className="hero-grid">
            <div>
              <div style={{ display:"inline-flex", alignItems:"center", gap:8, background:T.tealLight, borderRadius:4, padding:"5px 14px", marginBottom:24 }}>
                ...
                <span style={{ fontFamily:T.sans, fontSize:10.5, fontWeight:700, color:T.teal, letterSpacing:"0.12em", textTransform:"uppercase" }}>Telecom Engineering Centre</span>
              </div>
      ...
      <section className="sec" style={{ background:T.cream }}>
        <div className="inner">
          <div style={{ textAlign:"center", marginBottom:52 }}>
            <div style={{ display:"flex", justifyContent:"center", marginBottom:16 }}><div className="sl-row"><div className="sl-line" /><span className="sl-text">Certification Types</span></div></div>
            <h2 style={{ fontFamily:T.serif, fontSize:"clamp(2rem,3.2vw,2.9rem)", color:T.slate, fontWeight:700, letterSpacing:"-0.01em", marginBottom:14 }}>TEC Certification Types</h2>
      ...
      <section className="sec" style={{ background:T.white }}>
        <div className="inner">
          <div style={{ textAlign:"center", marginBottom:52 }}>
            ...
            <h2 style={{ fontFamily:T.serif, fontSize:"clamp(2rem,3.2vw,2.9rem)", color:T.slate, fontWeight:700, letterSpacing:"-0.01em", marginBottom:14 }}>Certification Process</h2>
          </div>
      ...
      <section style={{ position:"relative", overflow:"hidden" }} className="sec">
        ...
        <div style={{ maxWidth:900, margin:"0 auto", position:"relative", zIndex:1 }}>
          ...
          <p style={{ textAlign:"center", marginTop:24, fontFamily:T.sans, fontSize:13, color:"rgba(255,255,255,0.50)" }}>
            ...
            <button onClick={() => router.push("/contact")} style={{ color:T.teal, fontWeight:600, background:"none", border:"none", cursor:"pointer", fontFamily:T.sans, fontSize:13 }}>Contact us for a free checklist →</button>
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth:1100, margin:"0 auto" }}>
          <div className="cta-split">
            <div>
              ...
              <h2 style={{ fontFamily:T.serif, fontSize:"clamp(1.9rem,3.2vw,2.9rem)", color:T.slate, fontWeight:700, lineHeight:1.1, letterSpacing:"-0.01em", marginBottom:14 }}>Get Your Telecom<br />Product Certified</h2>
              <p style={{ fontFamily:T.sans, color:T.muted, fontSize:14.5, lineHeight:1.8 }}>Our TEC experts will guide you through the entire MTCTE process quickly and accurately. Free consultation. Clear timeline.</p>
            </div>
